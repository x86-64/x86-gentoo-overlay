...
# $Header: /var/cvsroot/gentoo-x86/net-dns/bind-tools/bind-tools-9.9.2_p2.ebuild,v 1.1 2013/03/29 13:05:51 idl0r Exp $
...
IUSE="doc gssapi idn ipv6 readline ssl urandom xml prompt"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-9.9.1_p2-nofatal.patch
	if use prompt; then
